...
@Autonomous (name = "Red Alliance Carousel-Red Warehouse")
@Disabled
...
//this was suppose to be 50
        ...
        Trajectory lineUpToCarouselP3 = drive.trajectoryBuilder(lineUpToCarouselP2.end())
                ...
                .build();
        Trajectory lineUpToWarehouseParkingP1 = drive.trajectoryBuilder(lineUpToCarouselP3.end())
        ...
        Trajectory lineUpToWarehouseParkingP3 = drive.trajectoryBuilder(lineUpToWarehouseParkingP2.end())
                .splineToLinearHeading(new Pose2d(40, -65, Math.toRadians(0)), Math.toRadians(0))
                .build();

        Trajectory lineUpToWarehouseParkingP4 = drive.trajectoryBuilder(lineUpToWarehouseParkingP3.end())
        ...
        sleep(100); // replace this with spinning of carousel
        //drive.followTrajectory(lineUpToWarehouseParkingP4);
        //sleep(100); // replace this with spinning of carousel

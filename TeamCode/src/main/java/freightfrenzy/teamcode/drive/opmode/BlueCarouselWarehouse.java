...
@Autonomous (name = "Blue Alliance Carousel-Blue Warehouse")
@Disabled
    ...
    public void runOpMode() throws InterruptedException {
       ...
       Trajectory lineuptoCarouselP2 = drive.trajectoryBuilder(lineuptoCarouselP1.end())
        ...
        Trajectory lineUpToCarouselP3 = drive.trajectoryBuilder(lineuptoCarouselP2.end())
                .lineTo(new Vector2d(-60, 59.5), drive.getVelocityConstraint(10, MAX_ANG_VEL, TRACK_WIDTH), drive.getAccelerationConstraint(MAX_ACCEL))
                .build();

        Trajectory lineUpToWarehouseParkingP1 = drive.trajectoryBuilder(lineUpToCarouselP3.end())
                .splineToLinearHeading(new Pose2d(0, 72, Math.toRadians(0)), Math.toRadians(0))
                .build();

...
@Disabled
@Autonomous(name = "BlueLeftMediumDropAT-DeadWheel")

public class BlueAllianceLeftMedDropDW extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ATObjectDetection.initalizeTensorFlow(hardwareMap, telemetry, ATRobotEnumeration.AUTO_BLUE_LEFT_MEDIUM_SETUP);
        ...
        tophatController.setDesiredNoOfConesToPick(4);
        ...
        TrajectorySequence trajSeqConePickup = drive.trajectorySequenceBuilder(startPose)
                .addTemporalMarker(.001, ()->{
                    ...
                    tophatController.blueAllianceLeftAutonMedium();})
                ...
                .addTemporalMarker(4, ()->{
                    ...
                    tophatController.blueAllianceLeftAutonMedium();})
                .waitSeconds(1)
                .splineToLinearHeading(new Pose2d(38,(9+ATConstants.BLUE_LEFT_HIGH_DROP_CONE_PICKUP_OFFSET_Y), Math.toRadians(90)), Math.toRadians(0),drive.getVelocityConstraint(15, MAX_ANG_VEL, TRACK_WIDTH), drive.getAccelerationConstraint(MAX_ACCEL))
                .lineToConstantHeading(new Vector2d(39.5,(9+ATConstants.BLUE_LEFT_HIGH_DROP_CONE_PICKUP_OFFSET_Y)),drive.getVelocityConstraint(25, MAX_ANG_VEL, TRACK_WIDTH), drive.getAccelerationConstraint(MAX_ACCEL))
                .build();
        ...
        if (isAutonConePickupReady) {
            tophatController.setTophatAction(ATRobotEnumeration.AUTO_BLUE_LEFT_MEDIUM_PICK_CONE);
            ...
            tophatController.setTophatAction(ATRobotEnumeration.AUTO_BLUE_LEFT_MEDIUM_PARK);
        }
        if (tophatController.tophatAction==ATRobotEnumeration.AUTO_BLUE_LEFT_MEDIUM_PARK){
